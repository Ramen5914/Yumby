package net.ramen5914.yumby.screen.custom;

import com.mojang.blaze3d.systems.RenderSystem;
import net.ramen5914.yumby.Yumby;
import net.ramen5914.yumby.screen.renderer.FluidTankRenderer;
import net.ramen5914.yumby.util.MouseUtil;
...
public class TankScreen extends AbstractContainerScreen<TankMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Yumby.MOD_ID,"textures/gui/tank/tank_gui.png");
    ...
    private void assignFluidRenderer() {
        fluidRenderer = new FluidTankRenderer(64000, true, 16, 64);
    }
